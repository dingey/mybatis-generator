...
public class MybatisGeneratorImpl implements MybatisGenerator {
	...
	public MybatisGenerator generateModel(String packagePath) {
		...
		for (Table t : tables) {
			...
			String upper = Str.of(t.getName()).camelCase().firstUpper().toString();
			...
			s.append("public class ").append(Str.of(t.getName()).camelCase().firstUpper());
			if (extendsModel != null) {
	...
	public MybatisGenerator generateMapper(String packagePath) {
		...
		for (Table t : tables) {
			...
			String name = Str.of(t.getName()).camelCase().toString();
			String upperName = Str.of(t.getName()).camelCase().firstUpper().toString();
